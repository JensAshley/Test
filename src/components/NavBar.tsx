...
const NavBar = () => {
  return (
    <Navbar
      ...
      style={{ backgroundColor: "#0352A0", height: "100vh", width: "100px" }}
    >
      <Container
        className="d-flex flex-column align-items-start"
        style={{ height: "100vh", width: "250px" }}
      >
        <Navbar.Brand href="#home" className="mb-4" style={{color: "white", fontWeight: "bold"}}>II-FF</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="flex-column w-100">
            <Nav.Link href="/home" style={{color: "white" }}>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-grid" viewBox="0 0 16 16">
            ...
            <Nav.Link href="/newpatient" style={{color: "white" }}>
